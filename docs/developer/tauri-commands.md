...
| `loadVideos`              | `path: string`                              | `Result<VideoClip[], string>`     | Load video clips    |
| `loadOrganizerConfig`     | none                                        | `Result<OrganizerConfig, string>` | Load swipe settings |
| `saveOrganizerConfig`     | `config: OrganizerConfig`                   | `Result<null, string>`            | Save swipe settings |
| `processClip`             | `clip: VideoClip, action: SwipeAction`      | `Result<string, string>`          | Process clip action |
| `undoAction`              | `currentPath: string, originalPath: string` | `Result<null, string>`            | Undo last action    |
